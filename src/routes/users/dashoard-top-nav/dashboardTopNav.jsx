...
const DashboardTopNav = ({ dashboardRoute, isMobile, setShowDashboardSidebar, showDashboardSidebar}) => {
            ...
            <DashboardNavItems>
              ...
              <NotificationProfileContainer>
                <NotificationIcon>
                  ...
                  {notifications.length && <span>{notifications.filter((item) => item.notification_status === false).length}</span>}
                </NotificationIcon>
                <DashboardImgContainer
                  onClick={() => setShowDropdown(!showDropdown)}
                >
                  <ProfileImg
                    src={!userProfile.display_picture ? userImage : userProfile.display_picture}
                    alt="profile picture"
