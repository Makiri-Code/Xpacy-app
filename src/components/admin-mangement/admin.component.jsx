  ...
  const facilityService = [
    {
      ...
      message:
        "Our expert plumbers are available for all your plumbing needs, from repairs to installations. Whether it's a leaky faucet, a broken pipe, or a full bathroom remodel, we’ve got you covered.",
    },
    {
      cardImage: card02,
      heading: "Cleaning Services",
      message:
        "Keep your property spotless with our professional cleaning services. From routine cleanings to deep cleans, we cater to residential and commercial spaces of all sizes.",
    },
    {
      cardImage: card03,
      heading: "Electrical Repairs",
      message:
        "Need electrical work done? Our certified electricians can handle everything from minor repairs to full rewiring. We ensure your home’s electrical system is safe and up to code.",
    },
    {
      cardImage: card04,
      heading: "Security Guard Services",
      message:
        "Ensure the safety of your property with our professional security guard services. We provide trained, reliable security personnel to monitor and protect your premises, offering peace of mind.",
    },
    {
      cardImage: card05,
      heading: "Pest Control",
      message:
        "Protect your property from unwanted pests with our reliable pest control services. We handle infestations, prevention, and routine treatments for homes and businesses.",
    },
    {
      cardImage: card06,
    ...
    },
    {
      ...
      message:
        "Create a beautiful outdoor space with our landscaping and lawn care services. We provide lawn mowing, tree trimming, garden design, and seasonal maintenance for a lush, green property.",
    },
    {
      cardImage: card08,
      heading: "Waste Management",
      message:
        "Ensure your property stays clean and eco-friendly with our waste management services. We provide scheduled trash collection for residential and commercial properties.",
    },
    {
      cardImage: card09,
      heading: "Appliance Repairs",
      message:
        "Our skilled technicians offer quick and efficient appliance repair services. From refrigerators to washing machines, we’ll get your appliances back up and running in no time.",
    },
  ];
  return (
    <>
      {/* Hero section */}
      <section
        className="management-hero-container"
        data-aos="fade-down"
            ...
            return (
              <div className="service-card" key={index}>
                <div
                  className="card-img"
                  style={{
                    background: `url(${cardImage}) lightgray 50% / cover no-repeat`,
                  }}
                />
                ...
                <Button
                  ...
                  onClick={() => {
                    navigate("/services/book-services");
                  }}
                >
                  Book Now
                </Button>
