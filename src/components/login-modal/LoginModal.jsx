...
const LoginModal = ({setShowLogInModal, navigateLink}) => {
    ...
    const {server, setUserToken, setUserData, setLoggedInUser} = useContext(UserContext)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetchServer("POST", body, '', 'user/login', server);
                ...
                <LogInModalContainer>
                    ...
                    <LogInForm>
                        ...
                        <LoginContent>
                            ...
                            <p className='form-txt'>Don't have an account? <AnchorTag fontWeight={700} to={'/auth/sign-up'}>Sign Up</AnchorTag></p>
                        </LoginContent>
                    </LogInForm>
                </LogInModalContainer>
